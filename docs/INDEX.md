...
- Verification target: `npm run lint`, `npx tsc --noEmit`, `npm test`, `npm run build`, `npm run test:e2e` for `/`, `/login`, `/signup`, `/app`, `/app/projects/visepanda-demo/verification` and a claim report.
