...
- Active objective: V1 public launch page, login/signup entry, protected workspace.
- Implemented: Next.js App Router, dark evidence-first design system, marketing page, preview/Supabase auth adapter, auth callback, logout, protected `/app`, privacy/terms, SEO metadata, sitemap, robots, baseline RLS migration.
